...
include_once '../core/destinations.class.php';
include_once '../core/take_off_times.class.php';
$bus_obj = new Buses();
$take_off_time_obj = new Take_off_times();
...
<!-- // END drawer-layout__content -->
 ...
 <div class="mdk-header-layout__content top-navbar mdk-header-layout__content--scrollable h-100">
  ...
  <div class="container-fluid">
            <h1 class="h2 mb-0">Add New Vehicle</h1>
            <hr>
            <div class="card card-body p-2">
               <form id="tripForm">
                   <div class="row">
                       ...
                       <select name="bus_id" class="form-control" required="required">
